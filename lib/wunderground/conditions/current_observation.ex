defmodule Wunderground.Conditions.CurrentObservation do
  ...
  @typedoc """
  The Wunderground.Conditions.CurrentObservation struct.

  ## Example

      %Wunderground.Conditions.CurrentObservation{
